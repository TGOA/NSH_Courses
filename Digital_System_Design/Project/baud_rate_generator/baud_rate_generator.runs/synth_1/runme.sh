...
HD_PWD='/home/it/eda_training/Digital_System_Design/Project/baud_rate_generator/baud_rate_generator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log transmitter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source transmitter.tcl
