...
HD_PWD='/home/it/eda_training/Digital_System_Design/Project/baud_rate_generator/baud_rate_generator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log transmitter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source transmitter.tcl -notrace
