...
#
# Generated by export_simulation on Thu Dec 05 19:46:51 +03 2024
#
################################################################################
...
'-reset_run' switch to the './tb_FPGA.sh' script.

./tb_FPGA.sh -reset_run
...
./tb_FPGA.sh -noclean_files

For more information on the script, please type './tb_FPGA.sh -help'.
